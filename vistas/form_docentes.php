        ...
        <!-- form modal contenido -->
                ...
                <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_documento" name="numero_documento" placeholder="Número de Documento" required = "true">                        
                    </div>                                
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_telefono" name="numero_telefono" placeholder="Número de Teléfono" required = "true">                        
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php 
                            $docentesInst->getSelectInstitucion();
                         ?>
                    </div>
