...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
      ...
      <div class="col-lg-12">
          <h1 class="page-header titleprincipal"><img src="../img/botones/grupoonly.png">Grupo</h1> 
      </div>        
      <!-- /.col-lg-12 -->
      ...
      <div class="col-lg-12">
          <ol class="breadcrumb migadepan">
            ...
            <li><a class="migadepan" href="grupo.php">Grupos</a></li>
            <li class="active migadepan">Detalles Grupo</li>
          </ol>
      </div>
			...
			<div role="tabpanel" class="tab-pane" id="estudiantes">
				...
				<div class="panel panel-default proc-pan-def3">
					...
					<div class="titulohead">
			            ...
			            <div class="row">
			              <div class="col-md-6">
			                  <div class="titleprincipal"><h4>Estudiantes Asignados</h4></div>
			              </div>
			              <div class="col-md-6 text-right">
			      			 <button id="btn_nuevoestudiante" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-target="#frm_modal_estudiante" <?php if (($creaeg != 1) || ($ne >= 30)){echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span> Crear Estudiante</button>
			              </div>
			            </div>
						...
						<div class="col-md-12">
							<div class="dataTable_wrapper">
				              <table class="display table table-striped table-bordered table-hover" id="tbl_grupo_estudiante">
				                  ...
				                  <tbody>
				                      <?php                          
				                          $detalles_grupoInst->getTablaGrupoUsuarios(9,$pkID_grupo);                           
				                       ?>
				                  </tbody>
				              </table>
					        </div>
