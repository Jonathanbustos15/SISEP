        ...
        <div class="panel-body">
          <div class="col-sm-12 panel panel-default">
                <h3><strong>Descripción</strong></h3><br>
                  <div class=""><h4 class="text-justify">Pero debo explicarles cómo nació toda esta idea errónea de denunciar el placer y elogiar el dolor, y le daré una descripción completa del sistema, y ​​explicaré las enseñanzas reales del gran explorador de la verdad, el maestro de la construcción humana. felicidad. Nadie rechaza, disgusta o evita el placer en sí mismo, porque es placer, sino porque aquellos que no saben cómo buscar placer de manera racional encuentran consecuencias que son extremadamente dolorosas. Tampoco hay nadie que ame o persiga o desee obtener dolor por sí mismo, porque es dolor, pero en ocasiones ocurren circunstancias en las que el trabajo y el dolor pueden proporcionarle un gran placer. Para tomar un ejemplo trivial, ¿quién de nosotros se compromete?¿Ejercicio físico laborioso, excepto para obtener alguna ventaja de ello? Pero, ¿quién tiene derecho a encontrar faltas en un hombre que elige disfrutar de un placer que no tiene consecuencias molestas, o uno que evita un dolor que no produce placer resultante. </h4></div>
              </div>
  <div class="col-sm-12 ">
