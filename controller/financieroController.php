...
class financieroController extends financieroDAO
{
    ...
    public function getTablafinancieroUsuario($pkID_user)
    {
        ...
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        $financiero = $this->getGruposUsuario($pkID_user);
        //print_r($financiero);
    ...
    public function getDatafinancieroGen($pkID)
    {

        $this->financieroId = $this->getfinancieroId($pkID);
        ...
        echo '<div class="col-sm-6">
                ...
                <div class="text-center">
                  <img src="../server/php/files/' . $this->financieroId[0]["url_logo"] . '" alt="..." height="250" width="250" class="img-thumbnail">
                </div>
            ...
            <div class="col-sm-6"> 
                <div class="form-group " hidden>                     
                            <input type="text" class="form-control" id="fkID_grupo" name="fkID_grupo" value='.$this->financieroid[0]["fkID_grupo"].'>
                        </div>
              <strong>Fecha de Salida: </strong> ' . $this->financieroId[0]["fecha_salida"] . ' <br> <br>
              <strong>Grupo: </strong> ' . $this->financieroId[0]["nombre"] . ' <br> <br>
              <strong>Comunidad Visitada: </strong> ' . $this->financieroId[0]["comunidad_visitada"] . ' <br> <br>
              <strong>Numero de participantes: </strong> ' . $this->financieroId[0]["canti"] . ' <br> <br>
              <strong>Asesor Asignado: </strong> ' . $this->financieroId[0]["nombres_funcionario"] . ' <br> <br>
            <div  class="">
            <label class="align-center">Lista de Asistencia:</label><br><br>
              ...
              <a id="btn_doc" title="Descargar Archivo" name="download_documento" type="text" class="" href = "../server/php/files/'.$this->financieroId[0]["url_lista"].'" target="_blank" >'.$this->financieroId[0]["url_lista"].'</a><br><br><br>
              </div>
              ';
    ...
    public function getTablaGrupoUsuarios($fkID_tipo_usuario, $pkID_saber)
    {
        ...
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        $financiero = $this->getGrupoUsuarios($fkID_tipo_usuario, $pkID_saber);
        //print_r($financiero);
    ...
    public function getTablaEstudiantesfinanciero($pkID_saber)
    {
        ...
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        $financiero = $this->getEstudiantesfinanciero($pkID_saber);    
        //print_r($financiero);
    ...
    public function getTablaAlbumGrupo($pkID_saber)
    {
        ...
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        $financiero = $this->getAlbumGrupo($pkID_saber);
        //print_r($financiero);
